...
for i in range(40, 45, 1):
    ...
    np.save('finetune_list_trials_val_acc_np.npy', list_trials_val_acc_np)
    np.save('finetune_list_trials_val_loss_np.npy', list_trials_val_loss_np)
    np.save('finetune_list_trials_val_acc.npy', np.array(list_trials_val_acc))
    np.save('finetune_list_trials_val_loss.npy', np.array(list_trials_val_loss))
    np.save('finetune_list_trials_val_acc_nonnp.npy', list_trials_val_acc)
    np.save('finetune_list_trials_val_loss_nonnp.npy', list_trials_val_loss)
    ...
    classfic_report.savefig(os.path.join(image_dir, 'test_plot_classif_report_finetune' + str(i) + '.png'))
